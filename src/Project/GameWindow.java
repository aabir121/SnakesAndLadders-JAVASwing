...
{
//    boolean rollCondition=false;
    static JFrame frm=new JFrame();
    JPanel pnl=new JPanel();
    static JPanel MainPanel=new JPanel();
    static int plyrNum;
    static int turn_of_player=1;
    static int opp;
    static int pos1,pos2,pos3,pos4;
    static JLabel noti1=new JLabel();
    static JLabel noti2=new JLabel();
    static JButton roll=new JButton("ROLL!!");
    static JLabel pawn2=new JLabel();
    static JLabel pawn1=new JLabel();
    static JLabel pawn3=new JLabel();
    static JLabel pawn4=new JLabel();
    static JLabel plyr_number=new JLabel("");
    static JLabel plyrN=new JLabel();
    static JLabel plyr=new JLabel();
    static JLabel board=new JLabel("",SwingConstants.CENTER);

    static ActionListener rollAction;
    static JButton backBtn=new JButton("BACK");
    static int px1,py1,px2,py2,px3,py3,px4,py4;
    static boolean start=false,start1=false,start2=false,start3=false;
...
////>>>>Roll button<<<<<//////
        ...
        if(turn==false && opp==1)
            plyr.setText("Turn of comp");
        else if(opp==0)
            plyr.setText("  Turn of    ");
        ...
        if(opp==0)
            plyrN.setText("Total number of players: "+plyrNum);
        else if(opp==1)
        {
...
//        newF.setForeground(Color.black);
        ...
        color3.setText("    Player 3");
        color4.setText("    Player 4");
        ...
        rollAction=new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                if(e.getSource()==roll)
                {
                    ...
                    System.out.println("turn "+turn_of_player);
